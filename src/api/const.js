...
export const CLIENT_ID = 'o3eE_EEZoM8PbDmaCLzBig'; // https://www.reddit.com/prefs/apps
...
export const REDIRECT_URI = 'http://localhost:3000/auth'; // https://www.reddit.com/prefs/apps
